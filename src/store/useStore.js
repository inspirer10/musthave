    ...
    persist(
        (set, get) => ({
            ...
            addFavoriteItem: (item) => {
                ...
                if (!exists)
                    set((state) => ({
                        favItemsList: [...state.favItemsList, item],
                    }));
            },
        ...
        {
            name: 'musthave-storage', // klucz dla caĹ‚ego store
